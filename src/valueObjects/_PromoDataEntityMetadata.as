...
[ExcludeClass]
internal class _PromoDataEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "mixName", "mixGenre", "bio", "djName", "promoImage", "mixLen", "promoSectionName", "imageBig");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "mixName", "mixGenre", "bio", "djName", "promoImage", "mixLen", "promoSectionName", "imageBig");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "mixName", "mixGenre", "bio", "djName", "promoImage", "mixLen", "promoSectionName", "imageBig");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "mixName", "mixGenre", "bio", "djName", "promoImage", "mixLen", "promoSectionName", "imageBig");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("mixImageBig", "djID", "mixFile", "mixDesc", "mixID", "mixYear", "mixName", "mixGenre", "bio", "djName", "promoImage", "mixLen", "promoSectionName", "imageBig");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "PromoData";
    ...
    model_internal var _instance:_Super_PromoData;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _PromoDataEntityMetadata(value : _Super_PromoData)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity PromoData");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity PromoData");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of PromoData");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity PromoData");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity PromoData");
        }
