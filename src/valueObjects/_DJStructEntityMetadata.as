...
[ExcludeClass]
internal class _DJStructEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("id", "lastName", "username", "facebookLink", "bio", "djName", "email", "twitterLink", "firstName", "imageSmall", "password", "imageBig");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "lastName", "username", "facebookLink", "bio", "djName", "email", "twitterLink", "firstName", "imageSmall", "password", "imageBig");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "lastName", "username", "facebookLink", "bio", "djName", "email", "twitterLink", "firstName", "imageSmall", "password", "imageBig");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "lastName", "username", "facebookLink", "bio", "djName", "email", "twitterLink", "firstName", "imageSmall", "password", "imageBig");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("id", "lastName", "username", "facebookLink", "bio", "djName", "email", "twitterLink", "firstName", "imageSmall", "password", "imageBig");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "DJStruct";
    ...
    model_internal var _instance:_Super_DJStruct;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _DJStructEntityMetadata(value : _Super_DJStruct)
    {
        ...
        model_internal::propertyTypeMap["imageSmall"] = "String";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity DJStruct");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity DJStruct");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of DJStruct");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity DJStruct");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity DJStruct");
        }
