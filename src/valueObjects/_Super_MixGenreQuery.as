 ...
 * of this value object you may modify the generated sub-class of this class - MixGenreQuery.as.
 */
...
[ExcludeClass]
public class _Super_MixGenreQuery extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _MixGenreQueryEntityMetadata;
    ...
    private var _internal_creatorID : int;
    ...
    public function _Super_MixGenreQuery()
    {
        _model = new _MixGenreQueryEntityMetadata(this);
    ...
    {
        var oldValue:int = _internal_creatorID;
        if (oldValue !== value)
        {
            _internal_creatorID = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "creatorID", oldValue, _internal_creatorID));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _MixGenreQueryEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _MixGenreQueryEntityMetadata) : void
    {
        var oldValue : _MixGenreQueryEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
