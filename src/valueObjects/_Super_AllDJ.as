 ...
 * of this value object you may modify the generated sub-class of this class - AllDJ.as.
 */
...
[ExcludeClass]
public class _Super_AllDJ extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _AllDJEntityMetadata;
    ...
    private var _internal_imageBig : Object;
    ...
    public function _Super_AllDJ()
    {
        _model = new _AllDJEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get imageSmall() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get mixcount() : Number
    {
        return _internal_mixcount;
    }

    [Bindable(event="propertyChange")]
    public function get bio() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get imageBig() : Object
    {
    ...
    public function set imageSmall(value:Object) : void
    {
        var oldValue:Object = _internal_imageSmall;
        if (oldValue !== value)
        {
    ...
    public function set mixcount(value:Number) : void
    {
        var oldValue:Number = _internal_mixcount;
        if (isNaN(_internal_mixcount) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_mixcount = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "mixcount", oldValue, _internal_mixcount));
        }
    }

    public function set bio(value:Object) : void
    {
        var oldValue:Object = _internal_bio;
        if (oldValue !== value)
        {
            _internal_bio = value;
    ...
    public function set imageBig(value:Object) : void
    {
        var oldValue:Object = _internal_imageBig;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AllDJEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AllDJEntityMetadata) : void
    {
        var oldValue : _AllDJEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfImageSmall : Object;
    ...
    model_internal var _doValidationLastValOfBio : Object;
    ...
    model_internal var _doValidationLastValOfImageBig : Object;
