...
[ExcludeClass]
internal class _NewMixArrayEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("id", "mixArtist", "mixImageBig", "mixName", "mixGenre", "mixFile", "complete", "mixImageSmall", "user_id", "mixFileUser", "mixYear", "createDate");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "mixArtist", "mixImageBig", "mixName", "mixGenre", "mixFile", "complete", "mixImageSmall", "user_id", "mixFileUser", "mixYear", "createDate");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "mixArtist", "mixImageBig", "mixName", "mixGenre", "mixFile", "complete", "mixImageSmall", "user_id", "mixFileUser", "mixYear", "createDate");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "mixArtist", "mixImageBig", "mixName", "mixGenre", "mixFile", "complete", "mixImageSmall", "user_id", "mixFileUser", "mixYear", "createDate");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("id", "mixArtist", "mixImageBig", "mixName", "mixGenre", "mixFile", "complete", "mixImageSmall", "user_id", "mixFileUser", "mixYear", "createDate");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "NewMixArray";
    ...
    model_internal var _mixYearIsValid:Boolean;
    model_internal var _mixYearValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _mixYearIsValidCacheInitialized:Boolean = false;
    model_internal var _mixYearValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_NewMixArray;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _NewMixArrayEntityMetadata(value : _Super_NewMixArray)
    {
        ...
        model_internal::propertyTypeMap["mixArtist"] = "Object";
        model_internal::propertyTypeMap["mixImageBig"] = "Object";
        model_internal::propertyTypeMap["mixName"] = "Object";
        model_internal::propertyTypeMap["mixGenre"] = "Object";
        model_internal::propertyTypeMap["mixFile"] = "Object";
        model_internal::propertyTypeMap["complete"] = "int";
        model_internal::propertyTypeMap["mixImageSmall"] = "Object";
        model_internal::propertyTypeMap["user_id"] = "int";
        model_internal::propertyTypeMap["mixFileUser"] = "Object";
        model_internal::propertyTypeMap["mixYear"] = "Object";
        model_internal::propertyTypeMap["createDate"] = "Date";
        ...
        model_internal::_mixYearValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForMixYear);
        model_internal::_mixYearValidator.required = true;
        model_internal::_mixYearValidator.requiredFieldError = "mixYear is required";
        //model_internal::_mixYearValidator.source = model_internal::_instance;
        //model_internal::_mixYearValidator.property = "mixYear";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity NewMixArray");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity NewMixArray");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of NewMixArray");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity NewMixArray");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity NewMixArray");
        }
    ...
    public function invalidateDependentOnMixYear():void
    {
        if (model_internal::_mixYearIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfMixYear = null;
            model_internal::calculateMixYearIsValid();
        }
    }
    ...
    public function get mixYearValidator() : StyleValidator
    {
        return model_internal::_mixYearValidator;
    }

    model_internal function set _mixYearIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_mixYearIsValid;         
        if (oldValue !== value)
        {
            model_internal::_mixYearIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "mixYearIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get mixYearIsValid():Boolean
    {
        if (!model_internal::_mixYearIsValidCacheInitialized)
        {
            model_internal::calculateMixYearIsValid();
        ...
        return model_internal::_mixYearIsValid;
    }

    model_internal function calculateMixYearIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_mixYearValidator.validate(model_internal::_instance.mixYear)
        model_internal::_mixYearIsValid_der = (valRes.results == null);
        model_internal::_mixYearIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::mixYearValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::mixYearValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get mixYearValidationFailureMessages():Array
    {
        if (model_internal::_mixYearValidationFailureMessages == null)
            model_internal::calculateMixYearIsValid();

        return _mixYearValidationFailureMessages;
    }

    model_internal function set mixYearValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_mixYearValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_mixYearValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "mixYearValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("mixYear"):
            {
                return mixYearValidationFailureMessages;
            }
            case("createDate"):
            {
