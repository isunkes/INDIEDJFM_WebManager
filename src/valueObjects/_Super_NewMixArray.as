 ...
 * of this value object you may modify the generated sub-class of this class - NewMixArray.as.
 */
...
[ExcludeClass]
public class _Super_NewMixArray extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _NewMixArrayEntityMetadata;
    ...
    private var _internal_mixArtist : Object;
    private var _internal_mixImageBig : Object;
    private var _internal_mixName : Object;
    private var _internal_mixGenre : Object;
    private var _internal_mixFile : Object;
    private var _internal_complete : int;
    private var _internal_mixImageSmall : Object;
    private var _internal_user_id : int;
    private var _internal_mixFileUser : Object;
    private var _internal_mixYear : Object;
    private var _internal_createDate : Date;
    ...
    public function _Super_NewMixArray()
    {
        _model = new _NewMixArrayEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "mixYear", model_internal::setterListenerMixYear));
    ...
    [Bindable(event="propertyChange")]
    public function get mixArtist() : Object
    {
        return _internal_mixArtist;
    }

    [Bindable(event="propertyChange")]
    public function get mixImageBig() : Object
    {
        return _internal_mixImageBig;
    }

    [Bindable(event="propertyChange")]
    public function get mixName() : Object
    {
        return _internal_mixName;
    }

    [Bindable(event="propertyChange")]
    public function get mixGenre() : Object
    {
        return _internal_mixGenre;
    }

    [Bindable(event="propertyChange")]
    public function get mixFile() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get mixImageSmall() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get mixYear() : Object
    {
    ...
    public function set mixArtist(value:Object) : void
    {
        var oldValue:Object = _internal_mixArtist;
        if (oldValue !== value)
        {
    ...
    public function set mixImageBig(value:Object) : void
    {
        var oldValue:Object = _internal_mixImageBig;
        if (oldValue !== value)
        {
    ...
    public function set mixName(value:Object) : void
    {
        var oldValue:Object = _internal_mixName;
        if (oldValue !== value)
        {
    ...
    public function set mixGenre(value:Object) : void
    {
        var oldValue:Object = _internal_mixGenre;
        if (oldValue !== value)
        {
    ...
    public function set mixFile(value:Object) : void
    {
        var oldValue:Object = _internal_mixFile;
        if (oldValue !== value)
        {
    ...
    public function set mixImageSmall(value:Object) : void
    {
        var oldValue:Object = _internal_mixImageSmall;
        if (oldValue !== value)
        {
    ...
    public function set mixYear(value:Object) : void
    {
        var oldValue:Object = _internal_mixYear;
        if (oldValue !== value)
        {
    ...
    {
        var oldValue:Date = _internal_createDate;
        if (oldValue !== value)
        {
    ...
    model_internal function setterListenerMixYear(value:flash.events.Event):void
    {
        _model.invalidateDependentOnMixYear();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.mixYearIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_mixYearValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _NewMixArrayEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _NewMixArrayEntityMetadata) : void
    {
        var oldValue : _NewMixArrayEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfMixArtist : Object;
    ...
    model_internal var _doValidationLastValOfMixImageBig : Object;
    ...
    model_internal var _doValidationLastValOfMixName : Object;
    ...
    model_internal var _doValidationLastValOfMixGenre : Object;
    ...
    model_internal var _doValidationLastValOfMixFile : Object;
    ...
    model_internal var _doValidationLastValOfMixImageSmall : Object;
    ...
    model_internal var _doValidationCacheOfMixYear : Array = null;
    model_internal var _doValidationLastValOfMixYear : Object;

    model_internal function _doValidationForMixYear(valueIn:Object):Array
    {
        var value : Object = valueIn as Object;

        if (model_internal::_doValidationCacheOfMixYear != null && model_internal::_doValidationLastValOfMixYear == value)
           return model_internal::_doValidationCacheOfMixYear ;

        _model.model_internal::_mixYearIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isMixYearAvailable && _internal_mixYear == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "mixYear is required"));
        }

        model_internal::_doValidationCacheOfMixYear = validationFailures;
        model_internal::_doValidationLastValOfMixYear = value;

        return validationFailures;
    }
    
    model_internal var _doValidationCacheOfCreateDate : Array = null;
    model_internal var _doValidationLastValOfCreateDate : Date;
